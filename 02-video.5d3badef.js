 ...
 */var S=function(e,t,n){var r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"addEventListener",o=arguments.length>4&&void 0!==arguments[4]?arguments[4]:"removeEventListener",i="string"==typeof t?[t]:t;return i.forEach(function(t){e[r](t,n)}),{cancel:function(){return i.forEach(function(t){return e[o](t,n)})}}},M=void 0!==Array.prototype.indexOf,N="undefined"!=typeof window&&void 0!==window.postMessage;if(!T&&(!M||!N))throw Error("Sorry, the Vimeo Player API is not available in this browser.");var C="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:void 0!==u?u:"undefined"!=typeof self?self:{};!/*!
...
r(e.prototype,"set",function(e,t){if(n(this,"set"),!o(e))throw TypeError("Invalid value used as weak map key");var i=e[this._id];return i&&i[0]===e?i[1]=t:r(e,this._id,[e,t]),this}),r(e,"_polyfill",!0),e)}()}function o(e){return Object(e)===e}}("undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:C);var F=(e=n={exports:{}},n.exports,// special form of UMD for polyfilling across evironments
C[t="Promise"]=C[t]||function(){var e,t,n,r=Object.prototype.toString,o="undefined"!=typeof setImmediate?function(e){return setImmediate(e)}:setTimeout;// dammit, IE8.
...
"[object Array]"!=r.call(e)?t.reject(TypeError("Not an array")):new t(function(n,r){if("function"!=typeof n||"function"!=typeof r)throw TypeError("Not a function");s(t,e,function(e,t){n(t)},r)}))}),h)}(),e.exports&&(e.exports=C[t]),n.exports),L=new WeakMap;/**
 ...
 */var G={role:"viewer",autoPlayMuted:!0,allowedDrift:.3,maxAllowedDrift:1,minCheckInterval:.1,maxRateAdjustment:.2,maxTimeToCatchUp:1},H=/*#__PURE__*/function(e){!function(e,t){if("function"!=typeof t&&null!==t)throw TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),Object.defineProperty(e,"prototype",{writable:!1}),t&&g(e,t)}(a,e);var t,n,r,o,i=(t=b(),function(){var e,n=m(a);if(t){var r=m(this).constructor;e=Reflect.construct(n,arguments,r)}else e=n.apply(this,arguments);return function(e,t){if(t&&("object"==typeof t||"function"==typeof t))return t;if(void 0!==t)throw TypeError("Derived constructors may only return object or undefined");return E(e)}(this,e)});/**
   ...
   */function a(e,t){var n,r,o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{},u=arguments.length>3?arguments[3]:void 0;return h(this,a),y(E(r=i.call(this)),"logger",void 0),y(E(r),"speedAdjustment",0),/**
     ...
     * @return {Promise<void>}
     */function(e,t){return new Promise(function(n){!function r(){e.readyState===t?n():e.addEventListener("readystatechange",r,{once:!0})}()})}}]),a}(/*#__PURE__*/k(EventTarget)),Y=new WeakMap,$=new WeakMap,Q={},B=/*#__PURE__*/function(){var e;/**
   * Create a Player.
   *
...
if(Y.has(e))return Y.get(e);this._window=e.ownerDocument.defaultView,this.element=e,this.origin="*";var a=new F(function(t,n){if(r._onMessage=function(e){if(j(e.origin)&&r.element.contentWindow===e.source){"*"===r.origin&&(r.origin=e.origin);var o=q(e.data);if(o&&"error"===o.event&&o.data&&"ready"===o.data.method){var i=Error(o.data.message);i.name=o.data.name,n(i);return}var a=o&&"ready"===o.event,u=o&&"ping"===o.method;if(a||u){r.element.setAttribute("data-ready","true"),t();return}!/**
...
$.set(this,a),Y.set(this.element,this),"IFRAME"===this.element.nodeName&&V(this,"ping"),Q.isEnabled){var u=function(){return Q.exit()};this.fullscreenchangeHandler=function(){Q.isFullscreen?A(r,"event:exitFullscreen",u):I(r,"event:exitFullscreen",u),// eslint-disable-next-line
r.ready().then(function(){V(r,"fullscreenchange",Q.isFullscreen)})},Q.on("fullscreenchange",this.fullscreenchangeHandler)}return this}return(/**
   * Get a promise for a method.
   *
   * @param {string} name The API method to call.
   * @param {Object} [args={}] Arguments to send via postMessage.
   * @return {Promise}
   */v(t,[{key:"callMethod",value:function(e){var t=this,n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};return new F(function(r,o){// We are storing the resolve/reject handlers to call later, so we
// can’t return here.
// eslint-disable-next-line promise/always-return
return t.ready().then(function(){A(t,e,{resolve:r,reject:o}),V(t,e,n)}).catch(o)})}},{key:"get",value:function(e){var t=this;return new F(function(n,r){// We are storing the resolve/reject handlers to call later, so we
// can’t return here.
// eslint-disable-next-line promise/always-return
return e=P(e,"get"),t.ready().then(function(){A(t,e,{resolve:n,reject:r}),V(t,e)}).catch(r)})}},{key:"set",value:function(e,t){var n=this;return new F(function(r,o){if(e=P(e,"set"),null==t)throw TypeError("There must be a value to set.");// We are storing the resolve/reject handlers to call later, so we
// can’t return here.
// eslint-disable-next-line promise/always-return
...
return!!document[r.fullscreenEnabled]}}}),Q=i,/**
...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=ed(t)||0,ef(n)&&(s=!!n.leading,i=(f="maxWait"in n)?ec(ed(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(es())},m}(e,t,{leading:r,maxWait:t,trailing:o})};const eh="videoplayer-current-time",ep=document.querySelector("iframe"),ev=new B(ep,{loop:!0,fullscreen:!0,quality:"1080p"});ev.on("timeupdate",((a=J)&&a.__esModule?a.default:a)(function(e){let t=e.seconds;localStorage.setItem(eh,JSON.stringify(t))},1e3)),ev.setCurrentTime(JSON.parse(localStorage.getItem(eh))||0);//# sourceMappingURL=02-video.5d3badef.js.map

//# sourceMappingURL=02-video.5d3badef.js.map
