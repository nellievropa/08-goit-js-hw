...
const j=document.querySelector(".js-feedback-form"),S=document.querySelector('input[type="email"]'),T=document.querySelector('textarea[name="message"]');j.addEventListener("input",((e=n)&&e.__esModule?e.default:e)(function(e){O[e.target.name]=e.target.value,localStorage.setItem(h,JSON.stringify(O))},1e3)),j.addEventListener("submit",function(e){e.preventDefault(),localStorage.removeItem(h),e.currentTarget.reset(),// щоб видалити все
// localStorage.clear();
...
// }
// }
//# sourceMappingURL=03-feedback.b63c3cf5.js.map
