...
f=setTimeout(T,t),j(l))}return void 0===f&&(f=setTimeout(T,t)),u}return t=b(t)||0,y(n)&&(s=!!n.leading,a=(d="maxWait"in n)?g(b(n.maxWait)||0,t):a,m="trailing"in n?!!n.trailing:m),O.cancel=function(){void 0!==f&&clearTimeout(f),c=0,o=l=r=f=void 0},O.flush=function(){return void 0===f?u:h(v())},O}(e,t,{leading:o,maxWait:t,trailing:r})};let j=document.querySelector(".feedback-form"),S=document.querySelector('input[type="email"]'),T=document.querySelector('textarea[name="message"]');j.addEventListener("input",((e=n)&&e.__esModule?e.default:e)(function(e){O[e.target.name]=e.target.value,localStorage.setItem(h,JSON.stringify(O))},500)),j.addEventListener("submit",function(e){e.preventDefault(),localStorage.removeItem(h),// щоб видалити все
// localStorage.clear();
e.currentTarget.reset(),console.log(O)});let h="feedback-form-state",O={email:"",message:""},w=JSON.parse(localStorage.getItem(h));null!==w&&(O=w,S.value=w.email||"",T.value=w.message||"")}();//# sourceMappingURL=03-feedback.6b4faeaa.js.map

//# sourceMappingURL=03-feedback.6b4faeaa.js.map
